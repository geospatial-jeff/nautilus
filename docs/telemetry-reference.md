...
| `runtime.step_micros` | counter | microseconds | COUNTERS | sum | operator_id, subtask_index | Summed wall time spent inside synchronous process/on_watermark critical sections. | runtime.await_count |  |
